                ...
                <div class="row">
                    <div class="col-12 p-5">
                        ...
                        <div class="col-4 text-center">
                            <h2>{{__('application.editing_application')}}</h2>
                        </div>
                        <div class="col-4">
                            <hr>
                        </div>
                        <div class="col-12 p-3">
                            <form method="POST" action="{{ route('user.application.update', $appl->id) }}">
                                @csrf
                                {{method_field('PUT')}}

                                <div class="col-6">
                                    <!-- Uprava preferencií ubytovania -->
                                                ...
                                                <div class="radio">
                                                    <label for="accom_1" class="form-check-label">
                                                        <input type="radio" id="accom_1" name="accom" value="1"
                                                               ...
                                                               @if($appl->accom_1 == 1) checked @endif>
                                                ...
                                                <div class="radio">
                                                    <label for="accom_2" class="form-check-label">
                                                        <input type="radio" id="accom_2" name="accom" value="2"
                                                               class="form-check-input"
                                                               @if($appl->accom_2 == 1) checked @endif>
                                                ...
                                                <div class="radio">
                                                    <label for="accom_3" class="form-check-label">
                                                        <input type="radio" id="accom_3" name="accom" value="3"
                                                               class="form-check-input"
                                                               @if($appl->accom_3 == 1) checked @endif>
                                                ...
                                                <div class="radio">
                                                    <label for="accom_4" class="form-check-label">
                                                        <input type="radio" id="accom_4" name="accom" value="4"
                                                               class="form-check-input"
                                                               @if($appl->accom_4 == 1) checked @endif>
                                                ...
                                                <div class="radio">
                                                    <label for="accom_5" class="form-check-label">
                                                        <input type="radio" id="accom_5" name="accom" value="5"
                                                               class="form-check-input"
                                                               @if($appl->accom_5 == 1) checked @endif>
                                            ...
                                            <div class="radio">
                                                <label for="accom_98" class="form-check-label">
                                                    <input type="radio" id="accom_98" name="accom" value="98"
                                                           class="form-check-input"
                                                           @if($appl->accom_98 == 1) checked @endif>
                                            ...
                                            <div class="radio">
                                                <label for="accom_99" class="form-check-label">
                                                    <input type="radio" id="accom_99" name="accom" value="99"
                                                           class="form-check-input"
                                                           @if($appl->accom_99 == 1) checked @endif>
                                                    <strong>{{__('application.accom_no_accommodation')}}</strong>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Uprava preferencií naspecialne udalosti -->
                                                ...
                                                <div class="checkbox">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" class="form-check-input" value="1"
                                                               name="special_1"
                                                               @if($appl->special_1) checked @endif>{{ App::getLocale() == 'en' ? $config->special_1_en : $config->special_1_sk  }}
                                                    </label>
                                                </div>
                                            @endif
                                            @if($config->special_2 == 1)
                                                <div class="checkbox">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" class="form-check-input" value="1"
                                                               name="special_2"
                                                               @if($appl->special_2) checked @endif>{{ App::getLocale() == 'en' ? $config->special_2_en : $config->special_2_sk  }}
                                                    </label>
                                                </div>
                                            @endif
                                            @if($config->special_3 == 1)
                                                <div class="checkbox">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" class="form-check-input" value="1"
                                                               name="special_3"
                                                               @if($appl->special_3) checked @endif>{{ App::getLocale() == 'en' ? $config->special_3_en : $config->special_3_sk  }}
                                                    </label>
                                                </div>
                                            @endif
                                        </div>
                                ...
                                <div class="col-6">
                                    <!-- Uprava preferencií stravovania -->
                                                            ...
                                                            <div class="checkbox">
                                                                <label for="day_{{$i}}_breakfast"
                                                                    ...
                                                                    <input type="checkbox" id="day_{{$i}}_breakfast"
                                                                           ...
                                                                           class="form-check-input"
                                                                           @if($appl['day'.$i."_breakfast"] == 1) checked @endif>
                                                            ...
                                                            <div class="checkbox">
                                                                <label for="day_{{$i}}_lunch" class="form-check-label">
                                                                    <input type="checkbox" id="day_{{$i}}_lunch"
                                                                           ...
                                                                           class="form-check-input"
                                                                           @if($appl['day'.$i."_lunch"] == 1) checked @endif>
                                                            ...
                                                            <div class="checkbox">
                                                                <label for="day_{{$i}}_dinner" class="form-check-label">
                                                                    <input type="checkbox" id="day_{{$i}}_dinner"
                                                                           ...
                                                                           class="form-check-input"
                                                                           @if($appl['day'.$i."_dinner"] == 1) checked @endif>
