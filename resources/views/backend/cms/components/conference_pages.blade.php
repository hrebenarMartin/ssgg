<div class="col-lg-6 col-md-12 col-sm-12">
    <div class="card">
        <div class="card-header">
            <strong class="card-title">{{ __('form.cms_pages_conference') }}</strong>
        </div>
        <div class="card-body">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th scope="col" style="width:40%;" class="text-right">{{ __('form.actions') }}</th>
                </tr>
                </thead>
                <tbody>
                @if (isset($pages_conference))

                    @foreach($pages_conference as $page)
                        <tr>
