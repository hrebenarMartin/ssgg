...
@section('title', __('titles.cms_page_content_add'))
    ...
    <div class="col-md-12">
        <div class="container">
            <div class="d-flex flex-row-reverse">
                <div class="p-1">
                    <a href="{{ route('admin.content.show', $page_id) }}" class="btn btn-primary"><i class="fa fa-chevron-circle-left"></i> {{ __('form.action_back') }}</a>
                </div>
            </div>
        </div>
        <hr>
        <div class="card">
            <div class="card-header">
                <strong class="card-title">{{ __('form.cms_block_add_form') }}</strong>
            </div>
            <div class="card-body">
                <form id="content_ssgg_add" method="POST" action="{{ route('admin.content.store') }}">
                @csrf
            ...
            <!--Basic fields-->
                <div class="row form-group">
                    ...
                    <div class="col col-md-4">
                        <input type="text" class="form-control" id="block_title" name="block_title" value="{{ old('block_title') }}" required>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col col-md-3">
                        <select class="form-control" id="block_type" name="block_type" required>
                            ...
                            <option value="1" @if(old('block_type') == 1) selected @endif>{{ __('form.cms_block_type_plaintext') }}</option>
                            <option value="2" @if(old('block_type') == 2) selected @endif>{{ __('form.cms_block_type_markdown') }}</option>
                            <option value="3" @if(old('block_type') == 3) selected @endif>{{ __('form.cms_block_type_html') }}</option>
                            <option value="4" @if(old('block_type') == 4) selected @endif>{{ __('form.cms_block_type_fixed') }}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row form-group" id="content_text">
                    ...
                    <div class="col col-md-8">
                        <textarea id="block_content_text" class="form-control" name="block_content_text" rows="6">{{ old('block_content_text') }}</textarea>
                    </div>
                </div>
                ...
                <div class="row form-group" id="content_markdown">
                    ...
                    <div class="col col-sm-12">
                        <textarea id="block_content_markdown" class="form-control" name="block_content_markdown">{{ old('block_content_markdown') }}</textarea>
                    </div>
                </div>
                ...
                <div class="row form-group" id="content_html">
                    ...
                    <div class="col col-sm-12">
                        <textarea id="block_content_html" class="form-control" name="block_content_html" hidden>{{ old('block_content_html') }}</textarea>
                ...
                <div class="row form-group" id="content_fixed">
                    <div class="col col-md-2">
                        <label for="block_content_fixed" class="form-control-label">{{ __('form.cms_block_content') }}</label>
                    </div>
                    <div class="col col-md-8">
                ...
                <div class="row form-group" id="content_text_en">
                    ...
                    <div class="col col-md-8">
                        <textarea id="block_content_text_en" class="form-control" name="block_content_text_en" rows="6">{{ old('block_content_text_en') }}</textarea>
                    </div>
                </div>
                ...
                <div class="row form-group" id="content_markdown_en">
                    ...
                    <div class="col col-sm-12">
                        <textarea id="block_content_markdown_en" class="form-control" name="block_content_markdown_en">{{ old('block_content_markdown_en') }}</textarea>
                    </div>
                </div>
                ...
                <div class="row form-group" id="content_html_en">
                    ...
                    <div class="col col-sm-12">
                        <textarea id="block_content_html_en" class="form-control" name="block_content_html_en" hidden>{{ old('block_content_html_en') }}</textarea>
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-success" form="content_ssgg_add">{{ __('form.save') }}</button>
                <button type="reset" class="btn btn-danger" form="content_ssgg_add">{{ __('form.reset') }}</button>
            </div>
        </div>
    </div>
