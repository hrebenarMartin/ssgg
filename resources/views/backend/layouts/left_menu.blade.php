        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                @if(Auth::user()->roles()->where('role_id', 1)->first())
                    ...
                    <li>
                        <a href="{{ route('admin.contributions.index') }}"> <i class="menu-icon fas fa-copy"></i>{{ __('b_menu.contributions') }}</a>
                    </li>
                    <li>
                ...
                @if(isset($is_conference) and Auth::user()->roles()->where('role_id', 3)->first())
                    ...
                    <li>
                        <a href="{{route('admin.conferences.show', $is_conference->id)}}"><i class="menu-icon fa fa-search"></i>{{__('b_menu.conf_detail')}}</a>
                    </li>
                    <li>
                        <a href="#!"><i class="menu-icon fa fa-user-friends"></i>{{__('b_menu.conf_participants')}}</a>
                    </li>
                    <li>
                ...
                @if(Auth::user()->roles()->where('role_id', 4)->first())
                    ...
                    <li>
                        <a href="{{ route('review.myReview.index') }}"><i class="menu-icon far fa-edit "></i>{{__('b_menu.review')}}</a>
                    </li>
                @endif
